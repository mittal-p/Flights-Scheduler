...
<html>
    ...
    <body>
            ...
            <header>
                ...
                <nav id="top_nav1">
                    ...
                    <ul>
                        ...
                        <li style="background: skyblue ; font-style: italic"><a href="login.jsp" ><img style = " vertical-align: middle" src="assetss/login-variant.png" alt="">LOGIN</a></li>
        ...
        <br><br>
             ...
             <form class="col s12" action="ValidateLogin" method="POST">  
                ...
                <div class="row">
                 ...
                 <p>
                     <a href="ForgotPass1.jsp" target="_blank">Forgot password!!</a>
                 </p>
                 <br>
